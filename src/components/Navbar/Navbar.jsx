...
const Navbar = ({name}) => {
  ...
  return (
    <nav className="">
      <div className="max-w-full md:max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
          <span className="self-auto text-4xl font-semibold whitespace-nowrap dark:text-black">
            bkmrk'd
          </span>
        </a>
        <div className="flex-row md: flex md:order-1">
          ...
          <div className="relative hidden md:block">
            ...
            <input
              type="text"
              id="search-navbar"
              className="block w-[500px] p-2 ps-10 text-sm text-yellow-900 border border-yellow-300 rounded-lg bg-yellow-50 focus:ring-yellow-500 focus:border-yellow-500 dark:bg-black dark:border-yellow-600 dark:placeholder-yellow-600 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500"
              placeholder="Search..."
            />
          </div>
          ...
          <a
            ...
            >
              ...
              {isOpen && (
                <div className="absolute right-0 mt-2 w-56 " style={{ backgroundColor: '#ece4c9' }}>
        ...
        >
          ...
          <a href="#" className="ml-2 mr-2 bg-yellow-400 hover:bg-yellow-500 text-black font-medium py-2 px-9 rounded-lg flex items-center transition-transform transform hover:scale-105 hover:cursor-pointer">
          ...
          <div className="relative inline-block text-left">
                <a href="#" onClick={() => setIsOpen(!isOpen)} className="ml-2  hover:bg-white hover:rounded-full font-bold py-2 px-4 rounded flex items-center transition-transform transform hover:scale-105 hover:cursor-pointer">
                  <img src={account} alt="" className="h-6 w-6" />
                </a>
                {isOpen && <Dropdown isSignedIn={isSignedIn} setIsSignedIn={setIsSignedIn} name={name} />}
