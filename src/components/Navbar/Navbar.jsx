        ...
        <div className="md:flex hidden relative ml-28 mr-8">
          ...
          >
            <input
              type="text"
              id="search-navbar"
              className="block w-full p-2 ps-10 text-md border border-yellow-300 rounded-lg focus:ring-yellow-500 focus:border-yellow-500 bg-stone-900 placeholder-yellow-600"
              placeholder="Search..."
              value={searchQuery}
